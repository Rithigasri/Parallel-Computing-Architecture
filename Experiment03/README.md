# EXPERIMENT 03: SIMPLE WARP DIVERGENCE-IMPLEMENT SUM REDUCTION
## AIM:
...
```
## OUTPUT:  
![image](https://github.com/Rithigasri/Parallel-Computing-Architecture/assets/93427256/59a810a4-28f1-4df0-a5c9-1a3d05dd5f9d)  
## RESULT:
The performance metrics show that the reduceUnrolling16 provide better results with 0.000322 sec compared to the counterpart which took  0.000295 sec. Thus, the performance of two CUDA kernels, reduceUnrolling8 and reduceUnrolling16 has been compared successfully.
